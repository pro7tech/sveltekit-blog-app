...
>
  <div class="mb-80 mx-auto max-w-max">
    <main class="sm:flex">
      <p class="text-4xl font-bold tracking-tight text-sky-400 sm:text-5xl">
        404
      </p>
      <div class="sm:ml-6">
        ...
        >
          <a
            href="/"
            class="inline-flex items-center rounded-md border border-transparent bg-sky-400 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:ring-offset-2"
            >Go back home</a
          >
          <a
            href="/"
